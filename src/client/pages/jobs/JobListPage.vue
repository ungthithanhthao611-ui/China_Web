          ...
          <div class="joinus-filterbox">
            <div class="joinus-filters">
              <label class="joinus-filter" for="joinus-position-filter">
                <span>Select PositionÃ¯Â¼Å¡</span>
              ...
              <label class="joinus-filter" for="joinus-department-filter">
                <span>Recruitment DepartmentÃ¯Â¼Å¡</span>
            ...
            >
              <div class="joinus-jobcard__content">
                <div class="joinus-jobcard__left">
                  <h3>{{ job.title }}</h3>
                  <ul>
                    <li>Release timeÃ¯Â¼Å¡{{ job.releaseDate }}</li>
                    <li>Educational requirementsÃ¯Â¼Å¡{{ job.education }}</li>
                    <li>ageÃ¯Â¼Å¡{{ job.age }}</li>
                    <li>Work ExperienceÃ¯Â¼Å¡{{ job.experience }}</li>
                    <li>Work locationÃ¯Â¼Å¡{{ job.location }}</li>
                    <li>genderÃ¯Â¼Å¡{{ job.gender }}</li>
                    <li>Recruiting NumbersÃ¯Â¼Å¡{{ job.count }}</li>
                    <li>Nature of WorkÃ¯Â¼Å¡{{ job.workNature }}</li>
                  </ul>
                </div>

...
const subsidiaryItems = [
  {
    id: '1678649369783721984',
    title: 'China National Decoration (Hainan) Co., LTD',
    address:
      'Room 1007, Xinda Business Building, 48 Guomao Avenue, Longhua District, Haikou City, Hainan Province',
    phone: '010-65269998',
    email: 'CNDC@sinodecor.com',
    image: 'https://en.sinodecor.com/repository/portal-local/ngc202304190002/cms/image/35fd4b12-7608-457b-9ff1-58b8358ebec2.jpg'
  },
  {
    id: '1678649350821273600',
    title: 'China Decoration Liaoning Co., LTD',
    address: 'Shenyang Qipanshan scenic area Huanhu South Road Wanghu villa',
    phone: '010-65269998',
    email: 'CNDC@sinodecor.com',
    image: 'https://en.sinodecor.com/repository/portal-local/ngc202304190002/cms/image/ded7f266-b3fa-43a6-a5c2-8028061d9c11.jpg'
  },
  {
    id: '1678649214808383488',
    title: 'Zhongli Intelligent Assembly Technology Research Jiangsu Co., LTD',
    address:
      '9F, Building 16, Zilang Science and Technology City, No. 60 Chongzhou Avenue, Nantong Development Zone',
    phone: '010-65269998',
    email: 'CNDC@sinodecor.com',
    image: 'https://en.sinodecor.com/repository/portal-local/ngc202304190002/cms/image/ddce601c-8fa2-4cc2-a9d8-687ef49c4211.jpg'
  },
  {
    id: '1678648937904627712',
    title: 'Ningbo China National Decoration Design and Research Institute Co., LTD',
    address: 'No. 178, New Road, Jiangbei District, Ningbo City',
    phone: '010-65269998',
    email: 'CNDC@sinodecor.com',
    image: 'https://en.sinodecor.com/repository/portal-local/ngc202304190002/cms/image/68fa8575-7756-4a8f-b3ed-1e3703619060.jpg'
  },
  {
    id: '1694195421597163520',
    title: 'China National Decoration Ecological (Beijing) Environment Co., LTD',
    address: 'Cuichang Technology Company, No. 99, Cuicun Industrial Park, Changping District, Beijing',
    phone: '010-65269998',
    email: 'CNDC@sinodecor.com',
    image: 'https://en.sinodecor.com/repository/portal-local/ngc202304190002/cms/image/d5f2f694-f4c1-4f3c-8463-6b6ac8c2abaa.jpg'
  },
  {
    id: '1694195687021109248',
    title: 'China National Decoration (Anhui) Building Decoration Co., LTD',
    address: '2516-3, Floor 25, Building A, Mingzhu Real Estate Plaza, Jinghu District, Wuhu City, Anhui Province',
    phone: '010-65269998',
    email: 'CNDC@sinodecor.com',
    image: 'https://en.sinodecor.com/repository/portal-local/ngc202304190002/cms/image/62f391cf-6077-40b8-8bc5-bf10b2a32c85.jpg'
  },
  {
    id: '1694195899173199872',
    title: 'China National Decoration Intelligent (Beijing) Digital Technology Co., LTD',
    address: 'Cuichang Technology Company, No. 99, Cuicun Industrial Park, Changping District, Beijing',
    phone: '010-65269998',
    email: 'CNDC@sinodecor.com',
    image: 'https://en.sinodecor.com/repository/portal-local/ngc202304190002/cms/image/93cdc7ab-b95f-46ee-bd2d-5fc6e83bf5a8.jpg'
  },
  {
    id: '1958808723589840896',
    title: 'Zhongzhuang Media (Beijing) Co., Ltd.',
    address: 'Cuichang Technology Company, No. 99, Cuicun Industrial Park, Changping District, Beijing',
    phone: '010-65269998',
    email: 'CNDC@sinodecor.com',
    image: 'https://en.sinodecor.com/repository/portal-local/ngc202304190002/cms/image/c8b65ef0-275f-437a-bfa2-1c77e5d3dcc4.png'
  }
]

const pageSize = 4
const totalPages = Math.ceil(subsidiaryItems.length / pageSize)

const pagedItems = computed(() => {
  const start = (currentPage.value - 1) * pageSize
  return subsidiaryItems.slice(start, start + pageSize)
})
...
const scrollToSection = (id) => {
  ...
  window.history.replaceState(null, '', `/subsidiary#${id}`)
}
...
watch(
  ...
  (value) => {
    ...
    window.history.replaceState(null, '', `/subsidiary#${value}`)
  },
  { immediate: true }
)
        ...
        <div class="subsidiary-tabbar">
          <div class="subsidiary-tabbar__inner">
            <router-link
              ...
              :class="{ active: tab.name === 'Subsidiary' }"
            >
              {{ tab.name }}
            </router-link>
          </div>
      ...
      <section id="ctn2" class="subsidiary-section subsidiary-list-section">
        <div class="subsidiary-list-shell" :class="{ 'is-visible': animatedSections.includes('ctn2') }">
          ...
          <div class="subsidiary-breadcrumb">
            ...
            <ChevronRight :size="14" />
            <span class="active">Subsidiary</span>
          </div>
            ...
            >
              <div class="subsidiary-card__content">
                ...
                <router-link
                  ...
                  :to="`/subsidiary_Detail/${item.id}.html`"
                >
                  <span>More</span>

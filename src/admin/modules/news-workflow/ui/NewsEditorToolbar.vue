...
const emit = defineEmits(['save', 'publish', 'preview', 'import-source'])
...
function onTextHeadingChange(event) {
...
async function handleImportImages(event) {
    ...
    <div class="toolbar-main">
      <div class="toolbar-groups">
        ...
        <div class="toolbar-group toolbar-group--compact">
          ...
          <select class="toolbar-select toolbar-select--wide" :value="fontFamily" @change="applyFontFamily($event.target.value)">
          ...
          <select class="toolbar-select" :value="fontSize" @change="applyFontSize($event.target.value)">

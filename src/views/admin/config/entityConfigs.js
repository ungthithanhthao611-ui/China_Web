...
export const ENTITY_MANAGER_CONFIGS = {
  ...
  content_block_items: {
    ...
    required: ['block_id'],
    fields: ['block_id', 'title', 'subtitle', 'content', 'image_id', 'sort_order'],
    fieldLabels: {
      block_id: 'Thuộc nhóm nội dung',
      title: 'Tên mục (Để bạn dễ tìm)',
      subtitle: 'Phụ đề / Chức vụ / Năm',
    ...
    fieldLabels: {
      block_id: 'Thuộc nhóm nội dung',
      title: 'Tiêu đề (Tên sếp/Năm...)',
      subtitle: 'Phụ đề (Chức vụ/Tháng...)',
      content: 'Nội dung chi tiết',
      image_id: 'Hình ảnh đính kèm',
      sort_order: 'Thứ tự',
    },
    placeholders: {
      item_key: 'Ví dụ: paragraph_1 hoặc timeline_2024',
      title: 'Ví dụ: Nguyễn Văn A hoặc Thành lập công ty',
      subtitle: 'Ví dụ: Giám đốc Điều hành hoặc Tháng 01',
    ...
    helpText: {
      ...
      item_key: 'Mã kỹ thuật định danh mục. Hãy giữ nó là chữ thường và không dấu.',
      image_id: 'Ảnh đại diện cho cá nhân (Ban lãnh đạo), ảnh mốc lịch sử hoặc logo đối tác.',
      metadata_json: 'Dùng cấu hình JSON để nhập thêm các trường như Năm (year), Phân loại (category), hoặc các trường tùy chỉnh khác.',
  ...
  products: {
    ...
    placeholders: {
      ...
      sku: 'FLR-OAK-001',
      image_url: 'Dán link ảnh hoặc chọn tệp tải lên phía trên.',
    ...
    helpText: {
      ...
      image_url: 'Làm ảnh đại diện sản phẩm. Có thể tải lên trực tiếp.',
      gallery_urls: 'Dán nhiều link ảnh HD, mỗi dòng một URL.',
